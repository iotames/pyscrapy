...
class AloyogaSpider(BaseSpider):
    ...
    allowed_domains = ['www.aloyoga.com']
    ...
    custom_settings = {
        ...
        'CONCURRENT_REQUESTS_PER_IP': 3,  # default 8
    ...
    # TODO
    def get_request_body(self, keyword, is_detail: bool):
    ...
    def start_requests(self):
        for handle in self.handle_list:
            ...
            body = self.get_request_body(handle, False)
    ...
    def parse_goods_detail(self, response: TextResponse):
        ...
        detail = goods_item["detail"]
        detail['desc'] = desc
        detail['fabrication'] = fabri
