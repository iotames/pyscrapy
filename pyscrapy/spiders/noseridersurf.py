...
class NoseridersurfSpider(BaseSpider):
    ...
    start_urls = ["https://noseridersurf.com/collections/all"]
    ...
    custom_settings = {
        ...
        'FEED_EXPORT_FIELDS': ['Thumbnail', 'Category', 'PublishedAt', 'Title', 'PriceText', 'OldPrice', 'FinalPrice', 'SizeList', 'SizeNum', 'Material', 'Url'],
